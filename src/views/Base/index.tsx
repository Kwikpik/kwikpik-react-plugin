...
export default function ViewBaseCard({ children, onClose }: ViewBaseCardProps) {
  return (
    <div className="w-screen min-h-screen absolute flex flex-col-reverse md:flex-row justify-start md:justify-center items-center md:items-start gap-5 backdrop-brightness-[.3] z-20 px-3 py-4 overflow-auto">
